...
typedef $$ScheduleTableInsertCompanionBuilder = ScheduleCompanion Function({
  Value<int> id,
  required String content,
  required DateTime date,
  required int startTime,
...
typedef $$ScheduleTableUpdateCompanionBuilder = ScheduleCompanion Function({
  Value<int> id,
  Value<String> content,
  Value<DateTime> date,
  Value<int> startTime,
...
class $$ScheduleTableTableManager extends RootTableManager<
    _$LocalDatabase,
    $ScheduleTable,
    ScheduleData,
    $$ScheduleTableFilterComposer,
    $$ScheduleTableOrderingComposer,
    $$ScheduleTableProcessedTableManager,
    $$ScheduleTableInsertCompanionBuilder,
  ...
  $$ScheduleTableTableManager(_$LocalDatabase db, $ScheduleTable table)
      : super(TableManagerState(
          ...
          table: table,
          filteringComposer:
              $$ScheduleTableFilterComposer(ComposerState(db, table)),
          orderingComposer:
              $$ScheduleTableOrderingComposer(ComposerState(db, table)),
          getChildManagerBuilder: (p) =>
              $$ScheduleTableProcessedTableManager(p),
...
class $$ScheduleTableProcessedTableManager extends ProcessedTableManager<
    _$LocalDatabase,
    $ScheduleTable,
    ScheduleData,
    $$ScheduleTableFilterComposer,
    ...
    $$ScheduleTableInsertCompanionBuilder,
    $$ScheduleTableUpdateCompanionBuilder> {
  $$ScheduleTableProcessedTableManager(super.$state);
}

class $$ScheduleTableFilterComposer
    extends FilterComposer<_$LocalDatabase, $ScheduleTable> {
  $$ScheduleTableFilterComposer(super.$state);
...
class $$ScheduleTableOrderingComposer
    extends OrderingComposer<_$LocalDatabase, $ScheduleTable> {
  $$ScheduleTableOrderingComposer(super.$state);
